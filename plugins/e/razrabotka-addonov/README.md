...
## 🧩 <mark style="color:#f43f5e;">Разработка аддонов для TreexClans</mark>
...
2. Реализуйте аддон (`extends JavaAddon`, `@ClanAddon`).
3. Соберите `.jar`.
4. Поместите его в `plugins/TreexClans/addons/`.
